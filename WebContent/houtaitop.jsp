		...
		<div class="frameMenu">
		    ...
		    <div class="menu">
		        <ul>
		        	...
		        	<li>
		        		<a class="menuFA" href="<%=request.getContextPath()%>/manage/kfgl.do?method=queryAll" ><i class="iconfont icon-liuliangyunpingtaitubiao03 left"></i>客房信息查询</a>
		        	</li>
		        	<li>
		        	...
		        	<li>
		        		<a class="menuFA" href="<%=request.getContextPath()%>/tgls/tjmanage/tongji.jsp" ><i class="iconfont icon-dajiantouyou left"></i>统计</a>
		        	</li>
		        	<li>
